...
\begin{lstlisting}
NANS : Nans
v_v : R, $\qquad$ BOUND : -2 <= v_v <= 2
v_x : R, $\qquad$ BOUND0 : 2 <= v_x <= 4
e0 : R, $\qquad$ E : Rabs e0 <= powerRZ 2 (-150)
d : R, $\qquad$ E0 : Rabs d <= powerRZ 2 (-24)
e1 : R, $\qquad$ E1 : Rabs e1 <= powerRZ 2 (-150)
e2 : R, $\qquad$ E2 : Rabs e2 <= powerRZ 2 (-150)
d0 : R, $\qquad$ E3 : Rabs d0 <= powerRZ 2 (-24)
e3 : R, $\qquad$ E4 : Rabs e3 <= powerRZ 2 (-150)
e4 : R, $\qquad$ E5 : Rabs e4 <= powerRZ 2 (-150)
d1 : R, $\qquad$ E6 : Rabs d1 <= powerRZ 2 (-24)
______________________________________(1/1)
Rabs
  ((v_x +
    (1 / 32 *
     ((v_v + (1 / 64 * ((3 - v_x) * (1 + d0) + e1) + e4)) *
      (1 + d) + e3) + e2)) * (1 + d1) + e0 -
...
\begin{itemize}
\item  The \lstinline{eexists} tactic introduces a unification variable
